...
set project_name "arbitration_demo_2"
...
set_global_assignment -name TOP_LEVEL_ENTITY Arbitration_part2
set_global_assignment -name PROJECT_OUTPUT_DIRECTORY ../output_files

# 2] include your relative path files here
set_global_assignment -name QIP_FILE ../../nios_system/synthesis/nios_system.qip
set_global_assignment -name QIP_FILE ../../src/external_RAM.qip
set_global_assignment -name VHDL_FILE ../../src/Arbitration_part2.vhd
set_global_assignment -name VHDL_FILE ../../src/external_RAM.vhd
set_global_assignment -name VHDL_FILE ../../src/RAM_controller.vhd
