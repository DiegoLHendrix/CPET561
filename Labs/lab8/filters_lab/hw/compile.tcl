...
set_global_assignment -name TOP_LEVEL_ENTITY high_pass_filter
...
set_global_assignment -name VHDL_FILE ../../src/multiplier.vhd
set_global_assignment -name VHDL_FILE ../../src/high_pass_filter.vhd
set_global_assignment -name VHDL_FILE ../../src/low_pass_filter.vhd
